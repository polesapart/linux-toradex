...
static void __init mach_ccwi9p9215js_init_machine(void)
{
	...
	ns9xxx_add_device_ccWi9p9215_wifi();
#endif
...
MACHINE_START(CC9P9215JS, "ConnectCore Wi-9P 9215 on a JSCC9P9215 Devboard")
	.map_io = ns921x_map_io,
	.init_irq = ns9xxx_init_irq,
	.init_machine = mach_ccwi9p9215js_init_machine,
	.timer = &ns921x_timer,
	.boot_params = 0x100,
MACHINE_END
