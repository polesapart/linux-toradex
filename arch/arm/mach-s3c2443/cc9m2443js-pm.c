...
/*
 * @XXX: Probably this is not the best place for recovering the configuration of
 * the SSMC for the Ethernet-controller, but otherwise we don't have any other
 * option.
 */
...
{
	/* Nothing to configure if no PM enabled */
}
#endif
